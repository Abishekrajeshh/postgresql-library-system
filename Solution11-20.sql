...
SELECT 
		...
		ist.issued_date,
	--	rs.return_date,
		CURRENT_DATE - ist.issued_date AS over_dues_date
...
BEGIN 
		--inserting into returns base on user input
		INSERT INTO return_status(return_id, issued_id, book_quality)
		VALUES 
...
SELECT 
		...
		SUM(bk.rental_price) as total_evenue
FROM issued_status AS ist
JOIN employees as e
